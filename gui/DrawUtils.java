...
public class DrawUtils {
    ...
    public void drawPath(Edge edge) {
        g.setColor(parseColor("#EFBC62"));
        drawBoldEdge(edge);
    }

    public void drawHoveredEdge(Edge edge) {
        g.setColor(parseColor("#6F80E7"));
        drawBoldEdge(edge);
    }
    ...
    public void drawSourceNode(Node node){
        g.setColor(parseColor("#FFCD62"));
        g.fillOval(node.getX() - radius, node.getY() - radius, 2 * radius, 2 * radius);

        radius-=5;
        g.setColor(parseColor("#DAFF81"));
        g.fillOval(node.getX() - radius, node.getY() - radius, 2 * radius, 2 * radius);
    ...
    public void drawNode(Node node){
        g.setColor(parseColor("#2d7019"));
        g.fillOval(node.getX() - radius, node.getY() - radius, 2 * radius, 2 * radius);

        radius-=5;
        g.setColor(parseColor("#cfee81"));
        g.fillOval(node.getX() - radius, node.getY() - radius, 2 * radius, 2 * radius);
